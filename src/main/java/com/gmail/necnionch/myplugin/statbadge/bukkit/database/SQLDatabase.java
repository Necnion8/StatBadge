...
public abstract class SQLDatabase implements StatBadgeDatabase {

    protected abstract Connection getConnection(boolean reconnect) throws SQLException;

    protected Connection getConnectionTry() throws SQLException {
